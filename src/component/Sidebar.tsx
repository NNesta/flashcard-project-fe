  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
      ...
      <div className='flex flex-col gap-y-12'>
         <div className='relative py-8'>
          {categoryToolTip && <h1 className='absolute left-0 top-0 bg-green-400 w-28 rounded-lg rounded-bl-none p-2 text-white text-xs z-50'>Create Category</h1>}
        ...
        <div className='relative py-8'>
          {flashcardToolTip && <h1 className='absolute left-0 top-0 w-28 bg-green-400 rounded-lg rounded-bl-none p-2 text-white text-xs z-50'>Create Flashcard</h1>}
